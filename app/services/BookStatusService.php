...
final class BookStatusService {
    ...
    public function changeStatus(array $data): TransitionResult {
        ...
        // Process any potential remaining e-mail data
        foreach ($result->notifications as $notiId) {
            $notifCtx = App::getService('notification')->getNotificationById($notiId);
            // queue email, add to operations, etc.
        }
