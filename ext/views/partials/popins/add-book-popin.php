            ...
            <div class="aletho-modal-body">
                ...
                <form id="add-book-form" method="post" action="/addBook">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <?php if (!empty($popErrors['title'])): ?>
                            <div class="aletho-alert-inline aletho-border"><?= htmlspecialchars($popErrors['title']) ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input  type="text"
                                ...
                                autocomplete="off"
                                data-context="popin">
                        <?php if (!empty($popErrors['writers'])): ?>
                            <div class="aletho-alert-inline aletho-border"><?= htmlspecialchars($popErrors['writers']) ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input  type="text"
                                ...
                                autocomplete="off"
                                data-context="popin">
                        <?php if (!empty($popErrors['genres'])): ?>
                            <div class="aletho-alert-inline aletho-border"><?= htmlspecialchars($popErrors['genres']) ?></div>
                        <?php endif; ?>
                    </div>
