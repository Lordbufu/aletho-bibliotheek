<div class="aletho-dropdown-body collapse" id="customSearchDropdown">
    <div class="aletho-dropdown-content" id="search-cont">
        ...
        <form class="form-row" id="search-form" novalidate>
            ...
            <input class="aletho-inputs" id="search-inp" type="text" name="searchInp" placeholder="Zoek op titel ..." required>
        </form>
