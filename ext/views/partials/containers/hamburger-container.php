<div class="aletho-dropdown-body collapse" id="customHamburgerDropdown" data-toggle-target="#id">
    <div class="hamburger-container" id="hamb-cont">
        <?php if(isset($_SESSION['user']) && $canEdit): ?>
        ...
        <form action="/logout" method="post">
            <button type="submit" class="aletho-buttons" id="logoff-button">Uitloggen</button>
        </form>
    </div>
</div>